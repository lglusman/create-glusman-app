...
import { useNivelesEducativosStore } from '../../services'

export const Incluir = () => {
  const SetIncluye = useNivelesEducativosStore((state) => state.SetIncluye)
  const SetOrden = useNivelesEducativosStore((state) => state.SetOrden)
